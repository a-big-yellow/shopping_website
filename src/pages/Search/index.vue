        ...
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{ active: isOne }" @click="chuangeOrder(1)">
                  <a
                    >综合<span v-show="isOne && isDesc">⬇</span
                    ><span v-show="isOne && isAsc">⬆</span></a
                  >
                </li>

                <li :class="{ active: isTwo }" @click="chuangeOrder(2)">
                  <a
                    >价格<span v-show="isTwo && isDesc">⬇</span
                    ><span v-show="isTwo && isAsc">⬆</span></a
                  >
                </li>
              </ul>
            </div>
